document.addEventListener("DOMContentLoaded", function() {
    ...
    const answers = [
        { word: "SHOES", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },
        { word: "BOOK", direction: "vertical", startRow: 0, startCol: 9, clueIndex: 1 },
        { word: "MUG", direction: "horizontal", startRow: 1, startCol: 2, clueIndex: 2 },
        { word: "BIN", direction: "vertical", startRow: 2, startCol: 4, clueIndex: 3 },
        { word: "KNIFE", direction: "horizontal", startRow: 8, startCol: 5, clueIndex: 4 },
        { word: "BOX", direction: "diagonal", startRow: 6, startCol: 1, clueIndex: 5 }
    ];
