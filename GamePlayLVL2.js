document.addEventListener("DOMContentLoaded", function() {
    ...
    const answers = [
        { word: "CHAIR", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },
        { word: "TABLE", direction: "vertical", startRow: 0, startCol: 6, clueIndex: 1 },
        { word: "SOFA", direction: "horizontal", startRow: 2, startCol: 0, clueIndex: 2 },
        { word: "BED", direction: "horizontal", startRow: 8, startCol: 3, clueIndex: 3 }, 
        { word: "DOOR", direction: "horizontal", startRow: 5, startCol: 2, clueIndex: 4 }, 
        { word: "CLOCK", direction: "vertical", startRow: 0, startCol: 10, clueIndex: 5 },
        { word: "DRAWER", direction: "horizontal", startRow: 6, startCol: 0, clueIndex: 6 },
        { word: "CABINET", direction: "vertical", startRow: 1, startCol: 8, clueIndex: 7 }
    ];
    ...
    // Timer functionality
    let timeLeft = 150; // 2 minutes in seconds
