document.addEventListener("DOMContentLoaded", function() {
    const gridSize = 15; // Set grid size to 10x10
const answers = [
    { word: "STEEL", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },
    { word: "NICKEL", direction: "vertical", startRow: 0, startCol: 14, clueIndex: 1 },
    { word: "CARBON", direction: "horizontal", startRow: 12, startCol:5, clueIndex: 2 },
    { word: "OBSIDIAN", direction: "vertical", startRow: 0, startCol: 10, clueIndex: 3 },
    { word: "GRAPHITE", direction: "horizontal", startRow: 14, startCol: 0, clueIndex: 4 },
    { word: "CERAMIC", direction: "diagonal", startRow: 1, startCol: 2, clueIndex: 5 },
    { word: "GRANITE", direction: "vertical", startRow: 5, startCol: 3, clueIndex: 6 },
    { word: "WOOL", direction: "horizontal", startRow: 12, startCol: 0, clueIndex: 7 },
    { word: "JADE", direction: "vertical", startRow: 8, startCol: 9, clueIndex: 8 },
    { word: "ZINC", direction: "horizontal", startRow: 7, startCol: 5, clueIndex: 9 },
    { word: "SILVER", direction: "vertical", startRow: 2, startCol: 9, clueIndex: 10 },
    { word: "PUMICE", direction: "horizontal", startRow: 9, startCol: 0, clueIndex: 11 }
];
    ...
    let tigerHealth = 12; // Initial health set to 6
    ...
    function showVictoryModal() {
        ...
        document.getElementById("nextLevelVictoryBtn").addEventListener("click", () => {
            victoryModal.remove();
            window.location.href = "GameplayLVL5.html"; // Replace with your next level page
        });
    }
    ...
    // Timer functionality
    let timeLeft = 500; // 2 minutes in seconds
