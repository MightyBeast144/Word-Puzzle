...
const answers = [
    { word: "HELIUM", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },    // Row 0
    { word: "BALLOON", direction: "vertical", startRow: 0, startCol: 0, clueIndex: 1 },     // Column 1
    { word: "SODA", direction: "horizontal", startRow: 2, startCol: 4, clueIndex: 2 },    // Row 2
    { word: "WHISTLE", direction: "diagonal", startRow: 0, startCol: 0, clueIndex: 3 },      // Column 4
    { word: "BUBBLES", direction: "horizontal", startRow: 6, startCol: 0, clueIndex: 4 },   // Row 5
    { word: "FREON", direction: "vertical", startRow: 0, startCol: 13, clueIndex: 5 },     // Starting at Row 1, Column 7
    { word: "OZONE", direction: "vertical", startRow: 0, startCol: 9, clueIndex: 6 },   // Column 9
    { word: "RADON", direction: "horizontal", startRow: 7, startCol: 0, clueIndex: 7 }
];
