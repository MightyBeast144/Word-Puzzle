...
const answers = [
    { word: "BUTANE", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },    // Row 0
    { word: "VAPOR", direction: "vertical", startRow: 0, startCol: 0, clueIndex: 1 },     // Column 1
    { word: "TOLUENE", direction: "horizontal", startRow: 2, startCol: 4, clueIndex: 2 },    // Row 2
    { word: "DUST", direction: "diagonal", startRow: 0, startCol: 0, clueIndex: 3 },      // Column 4
    { word: "FUMES", direction: "horizontal", startRow: 6, startCol: 0, clueIndex: 4 },   // Row 5
    { word: "SMOG", direction: "vertical", startRow: 0, startCol: 13, clueIndex: 5 },     // Starting at Row 1, Column 7
    { word: "KRYPTON", direction: "vertical", startRow: 0, startCol: 9, clueIndex: 6 },   // Column 9
    { word: "HALON", direction: "horizontal", startRow: 7, startCol: 0, clueIndex: 7 }, // Row 7
    { word: "SILANE", direction: "vertical", startRow: 3, startCol: 15, clueIndex: 8 },     // Column 10
    { word: "BIOGAS", direction: "horizontal", startRow: 8, startCol: 1, clueIndex: 9 }
];
