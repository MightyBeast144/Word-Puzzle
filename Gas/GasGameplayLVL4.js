...
const answers = [
    { word: "BROMINE", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },    // Row 0
    { word: "ETHANE", direction: "vertical", startRow: 0, startCol: 0, clueIndex: 1 },     // Column 1
    { word: "STIBINE", direction: "horizontal", startRow: 2, startCol: 4, clueIndex: 2 },    // Row 2
    { word: "FLUORINE", direction: "diagonal", startRow: 0, startCol: 0, clueIndex: 3 },      // Column 4
    { word: "XENON", direction: "horizontal", startRow: 6, startCol: 0, clueIndex: 4 },   // Row 5
    { word: "NEON", direction: "vertical", startRow: 0, startCol: 13, clueIndex: 5 },     // Starting at Row 1, Column 7
    { word: "OCTANE", direction: "vertical", startRow: 0, startCol: 9, clueIndex: 6 },   // Column 9
    { word: "BENZENE", direction: "horizontal", startRow: 7, startCol: 0, clueIndex: 7 }, // Row 7
    { word: "METHANE", direction: "vertical", startRow: 3, startCol: 15, clueIndex: 8 },     // Column 10
    { word: "ACROLEIN", direction: "horizontal", startRow: 8, startCol: 1, clueIndex: 9 },   // Row 8
    { word: "SPRAYS", direction: "vertical", startRow: 8, startCol: 8, clueIndex: 10 },  // Column 8
    { word: "MIST", direction: "horizontal", startRow: 10, startCol: 3, clueIndex: 11 }
];
