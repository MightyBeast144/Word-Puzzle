document.addEventListener("DOMContentLoaded", function() {
    const gridSize = 10; // Set grid size to 10x10
    const answers = [
        { word: "WATER", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },
        { word: "OIL", direction: "vertical", startRow: 0, startCol: 9, clueIndex: 1 },
        { word: "BLEACH", direction: "horizontal", startRow: 1, startCol: 2, clueIndex: 2 },
        { word: "MILK", direction: "vertical", startRow: 2, startCol: 4, clueIndex: 3 },
        { word: "JUICE", direction: "horizontal", startRow: 8, startCol: 5, clueIndex: 4 },
        { word: "LOTION", direction: "diagonal", startRow: 6, startCol: 1, clueIndex: 5 }
    ];
    ...
    let tigerHealth = 6; // Initial health set to 6
    ...
    function showVictoryModal() {
        ...
        document.getElementById("nextLevelVictoryBtn").addEventListener("click", () => {
            victoryModal.remove();
            window.location.href = "Gameplaylvl2.html"; // Replace with your next level page
        });
    }
