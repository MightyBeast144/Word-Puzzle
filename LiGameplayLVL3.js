document.addEventListener("DOMContentLoaded", function() {
    ...
    const answers = [
        { word: "DIESEL", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },
        { word: "BLOOD", direction: "vertical", startRow: 1, startCol: 6, clueIndex: 1 },
        { word: "PLASMA", direction: "horizontal", startRow: 1, startCol: 2, clueIndex: 2 },
        { word: "AMMONIA", direction: "vertical", startRow: 3, startCol: 9, clueIndex: 3 },
        { word: "TONIC", direction: "horizontal", startRow: 8, startCol: 5, clueIndex: 4 },
        { word: "GLUE", direction: "diagonal", startRow: 6, startCol: 1, clueIndex: 5 },
        { word: "SERUM", direction: "horizontal", startRow: 4, startCol: 3, clueIndex: 6 },
        { word: "CASTOR", direction: "vertical", startRow: 5, startCol: 0, clueIndex: 7 },
        { word: "LACTIC", direction: "horizontal", startRow: 7, startCol: 5, clueIndex: 8 },
        { word: "SALINE", direction: "vertical", startRow: 9, startCol: 8, clueIndex: 9 }
    ];
