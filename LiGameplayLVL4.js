...
const answers = [
    { word: "HERBICIDE", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },
    { word: "INSECTICIDE", direction: "vertical", startRow: 0, startCol: 14, clueIndex: 1 },
    { word: "KEROSENE", direction: "horizontal", startRow: 12, startCol:5, clueIndex: 2 },
    { word: "TURPENTINE", direction: "vertical", startRow: 0, startCol: 10, clueIndex: 3 },
    { word: "POLISH", direction: "horizontal", startRow: 14, startCol: 0, clueIndex: 4 },
    { word: "TAR", direction: "diagonal", startRow: 1, startCol: 2, clueIndex: 5 },
    { word: "LUBRICANT", direction: "vertical", startRow: 5, startCol: 3, clueIndex: 6 },
    { word: "LINSEED", direction: "horizontal", startRow: 12, startCol: 0, clueIndex: 7 },
    { word: "MERCURY", direction: "vertical", startRow: 8, startCol: 9, clueIndex: 8 },
    { word: "PROPANE", direction: "horizontal", startRow: 7, startCol: 5, clueIndex: 9 },
    { word: "ETHANOL", direction: "vertical", startRow: 2, startCol: 9, clueIndex: 10 },
    { word: "BILE", direction: "horizontal", startRow: 9, startCol: 0, clueIndex: 11 }
];
    ...
    // Timer functionality
    let timeLeft = 180; // 2 minutes in seconds
