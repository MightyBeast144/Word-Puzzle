...
const answers = [
    { word: "CRUDE", direction: "horizontal", startRow: 0, startCol: 0, clueIndex: 0 },    // Row 0
    { word: "URINE", direction: "vertical", startRow: 0, startCol: 0, clueIndex: 1 },     // Column 1
    { word: "MOLASSES", direction: "horizontal", startRow: 2, startCol: 4, clueIndex: 2 },    // Row 2
    { word: "LACQUER", direction: "diagonal", startRow: 0, startCol: 0, clueIndex: 3 },      // Column 4
    { word: "BRINE", direction: "horizontal", startRow: 6, startCol: 0, clueIndex: 4 },   // Row 5
    { word: "LARD", direction: "vertical", startRow: 0, startCol: 13, clueIndex: 5 },     // Starting at Row 1, Column 7
    { word: "RESIN", direction: "vertical", startRow: 0, startCol: 9, clueIndex: 6 },   // Column 9
    { word: "PHENOL", direction: "horizontal", startRow: 7, startCol: 0, clueIndex: 7 }, // Row 7
    { word: "CHLORINE", direction: "vertical", startRow: 3, startCol: 15, clueIndex: 8 },     // Column 10
    { word: "VARNISH", direction: "horizontal", startRow: 8, startCol: 1, clueIndex: 9 },   // Row 8
    { word: "OPIUM", direction: "vertical", startRow: 8, startCol: 8, clueIndex: 10 },  // Column 8
    { word: "BROMINE", direction: "horizontal", startRow: 10, startCol: 3, clueIndex: 11 }, // Row 10
    { word: "NECTAR", direction: "horizontal", startRow: 11, startCol: 0, clueIndex: 12 },    // Row 11
    { word: "BRINE", direction: "vertical", startRow: 5, startCol: 10, clueIndex: 13 }       // Column 7
];
    ...
    function showVictoryModal() {
        ...
        document.getElementById("nextLevelVictoryBtn").addEventListener("click", () => {
            victoryModal.remove();
            window.location.href = "nextLevel.html"; // Replace with your next level page
        });
    }
